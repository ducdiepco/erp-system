...
module PaymentApi
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['PAYMENT_API_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time PaymentApi::Action is included
      ...
      # Configure the code that will yield each time PaymentApi::View is included
      # This is useful for sharing common functionality
      #
